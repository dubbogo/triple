...
[`UnaryClientInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#UnaryClientInterceptor)
...
`DialOption`
[`WithUnaryInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#WithUnaryInterceptor).

#### Stream Interceptor

[`StreamClientInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#StreamClientInterceptor)
...
`DialOption`
[`WithStreamInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#WithStreamInterceptor).
...
[`UnaryServerInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#UnaryServerInterceptor)
...
`ServerOption`
[`UnaryInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#UnaryInterceptor).

#### Stream Interceptor

[`StreamServerInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#StreamServerInterceptor)
...
`ServerOption`
[`StreamInterceptor`](https://godoc.org/github.com/dubbogo/triple/pkg/grpc#StreamInterceptor).
