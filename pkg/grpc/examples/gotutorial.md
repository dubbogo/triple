...
```shell
$ go get github.com/dubbogo/triple/pkg/grpc
```

Then change your current directory to `grpc-go/examples/route_guide`:
```shell
$ cd $GOPATH/src/github.com/dubbogo/triple/pkg/grpc/examples/route_guide
```
...
`$GOPATH/src/github.com/dubbogo/triple/pkg/grpc/examples/route_guide`, simply:
