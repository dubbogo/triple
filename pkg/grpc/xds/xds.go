...
import (
	...
	internaladmin "github.com/dubbogo/triple/pkg/grpc/internal/admin"
	"github.com/dubbogo/triple/pkg/grpc/resolver"
	"github.com/dubbogo/triple/pkg/grpc/xds/csds"
	v3statusgrpc "github.com/envoyproxy/go-control-plane/envoy/service/status/v3"

	_ "github.com/dubbogo/triple/pkg/grpc/credentials/tls/certprovider/pemfile" // Register the file watcher certificate provider plugin.
	_ "github.com/dubbogo/triple/pkg/grpc/xds/internal/balancer"                // Register the balancers.
	_ "github.com/dubbogo/triple/pkg/grpc/xds/internal/httpfilter/fault"        // Register the fault injection filter.
	_ "github.com/dubbogo/triple/pkg/grpc/xds/internal/httpfilter/rbac"         // Register the RBAC filter.
	_ "github.com/dubbogo/triple/pkg/grpc/xds/internal/httpfilter/router"       // Register the router filter.
	xdsresolver "github.com/dubbogo/triple/pkg/grpc/xds/internal/resolver"      // Register the xds_resolver.
	_ "github.com/dubbogo/triple/pkg/grpc/xds/internal/xdsclient/v2"            // Register the v2 xDS API client.
	_ "github.com/dubbogo/triple/pkg/grpc/xds/internal/xdsclient/v3"            // Register the v3 xDS API client.
)
