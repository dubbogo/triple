...
# one of the sources.
OPTS=Mgrpc/service_config/service_config.proto=/internal/proto/grpc_service_config,Mgrpc/core/stats.proto=github.com/dubbogo/triple/pkg/grpc/interop/grpc_testing/core
...
mkdir -p ${WORKDIR}/out/github.com/dubbogo/triple/pkg/grpc/balancer/rls/internal/proto/grpc_lookup_v1
mv ${WORKDIR}/out/github.com/dubbogo/triple/pkg/grpc/lookup/grpc_lookup_v1/* ${WORKDIR}/out/github.com/dubbogo/triple/pkg/grpc/balancer/rls/internal/proto/grpc_lookup_v1

# grpc_testingv3/testv3.pb.go is not re-generated because it was
# intentionally generated by an older version of protoc-gen-go.
rm ${WORKDIR}/out/github.com/dubbogo/triple/pkg/grpc/reflection/grpc_testingv3/*.pb.go
...
cp -R ${WORKDIR}/out/github.com/dubbogo/triple/pkg/grpc/* .
