...
import (
	...
	_ "github.com/dubbogo/triple/pkg/grpc/balancer/grpclb"               // grpclb for config parsing.
	_ "github.com/dubbogo/triple/pkg/grpc/internal/resolver/passthrough" // passthrough resolver.
)
